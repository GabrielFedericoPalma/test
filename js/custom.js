        ...
        function shrink() {
            $(window).on('scroll', function(e) {
                var distanceY = $(window).pageYOffset || $(document).scrollTop(),
                    ...
                    isShrink = $(".is-shrink");
                    //console.log($('.nav-wrap'));
                if (distanceY > shrinkOn) {
                    isShrink.addClass("smaller");
                    //console.log("ROMI")
                    //$('#cambiarFill').addClass('dropWhenFill');
                } else {
        ...
        **********************************************/
        ...
        function headerFill() {
            $(window).on('scroll', function(e) {
                ...
                var drop = $('#cambiarFill');
                if (distanceY > navHeight && navWrap.data("is-fill") === true) {
                    navWrap.addClass('is-fill');
                        $('.dropdown-menu').addClass('dropWhenFill');
                        $('.fillTrue').addClass('changeHover');
                } else {
                    navWrap.removeClass('is-fill');
                    $('.dropdown-menu').removeClass('dropWhenFill');
                    $('.fillTrue').removeClass('changeHover');
                }
